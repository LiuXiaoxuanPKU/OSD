...
def preprocess_function_spider(examples, tokenizer, max_source_length, max_target_length, prefix="Could you translate the following question into SQL. Please only generate SQL, don't include explanation in the answer. "):
