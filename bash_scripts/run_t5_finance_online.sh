...
python3 -m torch.distributed.run --nproc_per_node=1 \
    ...
    --dataset_name finance_with_answers \
    --max_propose_num 5 \
    --mode online \
    --do_train \
    --num_train_epochs 1 \
    ...
    --run_name online_t5_finance_flan_teacher_2e-5lr \
    --output_dir /home/lanxiang/MIT/LLMs_and_TVM/specd/specNBCE-main/outputs/t5_finance_online_flan_teacher_2e-5lr 2>&1 | tee logs/train/online_finance_flant5_xl_to_t5small_trial_${trial}_flan_teacher.log
