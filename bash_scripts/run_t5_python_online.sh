...
python3 -m torch.distributed.run --nproc_per_node=1 \
    ...
    --dataset_name python_with_answers \
    --max_propose_num 5 \
    --mode online \
    --do_train \
    --num_train_epochs 1 \
    ...
    --run_name online_t5_python_shift_2e-5lr \
    --output_dir /home/lanxiang/MIT/LLMs_and_TVM/specd/specNBCE-main/outputs/t5_python_online_shift_2e-5lr_flanteacher 2>&1 | tee logs/train/online_python_t5_xl_to_small_trial_${trial}_shift_interval2_1e-5lr_flanteacher.log
