...
python3 -m torch.distributed.run --nproc_per_node=8 \
    ...
    --output_dir /home/lanxiang/MIT/LLMs_and_TVM/specd/specNBCE-main/flan_wmt_oneline_seqlen512 2>&1 | tee logs/train/online_wmt16_flan_xl_to_small_trial_${trial}.log
