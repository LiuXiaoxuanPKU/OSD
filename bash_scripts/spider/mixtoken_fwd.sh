WANDB_PROJECT=specInfer python distill/train.py \
    ...
    --max_propose_num 5 \
    --bf16 True \
    --output_dir /data/spider_mixtoken_fwd \
    --num_train_epochs 2 \
    ...
    --run_name spider_mixtoken_fwd \
    --mode offline \
    --sample_source mix_token \
    --kl_method forward

python distill/experiment/compare_model.py \
       --data data/spider_validation.json \
       --student /data/spider_mixtoken_fwd > output/spider_mixtoken_acc.out