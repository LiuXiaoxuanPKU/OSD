WANDB_PROJECT=specInfer python distill/train.py \
    ...
    --max_propose_num 5 \
    --bf16 True \
    --output_dir /data/spider_student_reverse \
    --num_train_epochs 2 \
    ...
    --run_name spider_student_reverse \
    --mode offline \
...
python distill/experiment/compare_model.py \
       --data /home/lily/spec_new/data/spider_validation.json \
       --student /data/spider_student_reverse  > output/spider_student_reverse_acc.out